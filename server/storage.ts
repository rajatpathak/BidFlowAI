...
export class MemStorage implements IStorage {
  ...
  private initializeSampleData() {
    ...
    const enhancedResult1: EnhancedTenderResult = {
      ...
      status: "won",
      awardedTo: "Appentus Technologies",
      awardedValue: 14500000,
      participatorBidders: ["Appentus Technologies", "BuildCorp India", "Metro Infra Solutions", "City Developers Ltd", "Smart Solutions Inc"],
    ...
    const enhancedResult2: EnhancedTenderResult = {
      ...
      participatorBidders: ["Appentus Technologies", "TaxSoft Solutions", "Revenue Systems Ltd", "Digital Tax Corp"],
    ...
    const enhancedResult3: EnhancedTenderResult = {
      ...
      participatorBidders: ["MedTech Supplies", "HealthCare Solutions", "Medical Systems India", "Appentus Healthcare Division"],
